...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post gyms_url, params: { gym: { email: @gym.email, name: @gym.name, primary_style: @gym.primary_style, telephone: @gym.telephone, user_id: @gym.user_id, website: @gym.website } }
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { email: @gym.email, name: @gym.name, primary_style: @gym.primary_style, telephone: @gym.telephone, user_id: @gym.user_id, website: @gym.website } }
